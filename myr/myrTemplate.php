...
final class myrTemplate {
    ...
    public static function formatResult($result, $params, $template_data) {
        ...
        if ($template_data == null) {
            ...
            $template_data->head = $params->{$head};
            $template_data->item = $params->{$item};
            $template_data->foot = $params->{$foot};

            //Set up links
            $links['detail-url'] = $params->{"detail-url"};
            $links['detail-url-vik'] = $params->{"detail-url-vik"};
            $links['detail-url-tabor'] = $params->{"detail-url-tabor"};
            $links['detail-url-klub'] = $params->{"detail-url-klub"};
            $links['detail-url-ekostan'] = "" . @$params->{"detail-url-ekostan"};
            $links['detail-url-vikeko'] = "" . @$params->{"detail-url-vikeko"};
        ...
        if ($result->data != false) {
            $return_text = '';
            //Master DIV
            $return_text.='<div class="' . $params->css_class . '">' . "\n";
